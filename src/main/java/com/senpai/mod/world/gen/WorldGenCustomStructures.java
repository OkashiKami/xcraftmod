package com.senpai.mod.world.gen;
...
import com.senpai.mod.world.gen.generators.WorldGenAluminiumTree;
import com.senpai.mod.world.gen.generators.WorldGenCopperTree;
import com.senpai.mod.world.gen.generators.WorldGenStructure;
...
public class WorldGenCustomStructures implements IWorldGenerator
{
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) 
	{
		...
		case 0:
			...
			runGenerator(COPPER, world, random, chunkX, chunkZ, 5, BlockInit.DIRT, BiomeCopper.class);
